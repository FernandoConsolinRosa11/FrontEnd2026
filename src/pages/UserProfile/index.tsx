  ...
  return (
    <div className=" bg-[#121212] text-white font-sans py-10!">
      <div className="max-w-2xl mx-auto px-4">
        ...
        <div className="border border-gray-700  bg-[#1a1a1a] p-1">
          {/* Header do Card */}
          ...
          <div className="p-2! space-y-4">
            ...
            <div className="flex justify-between items-center border-b border-gray-800 pb-2">
              <span className="text-lg uppercase tracking-widest text-gray-400">Email</span>
            ...
            <div className="flex justify-between items-center border-b border-gray-800 pb-2">
              <span className="text-lg uppercase tracking-widest text-gray-400">CEP</span>
              <span className="text-lg font-medium">87240-000</span>
            </div>

            <div className="flex justify-between items-center border-b border-gray-800 pb-2">
              <span className="text-lg uppercase tracking-widest text-gray-400">CPF</span>
              <span className="text-lg font-medium">098.996.319-57</span>
            </div>

            <div className="flex justify-between items-center border-b border-gray-800 pb-2">
              <span className="text-lg uppercase tracking-widest text-gray-400">Telefone</span>
              <span className="text-lg font-medium">55 44 99958-3036</span>
            </div>

            <div className="flex justify-between items-center border-b border-gray-800 pb-2">
              <span className="text-lg uppercase tracking-widest text-gray-400">Senha</span>
